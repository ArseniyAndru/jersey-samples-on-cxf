...
public abstract class AbstractWebAppTest {
    ...
    public List<Option> genericOsgiOptions() {
        ...
        String bundleLocation = mavenBundle().groupId("org.talend.jersey.cxf.helloworld-osgi-webapp").artifactId("war-bundle").type("war").versionAsInProject().getURL().toString();
        ...
        return Arrays.asList(options(
                ...
                mavenBundle().groupId("org.apache.servicemix.specs").artifactId("org.apache.servicemix.specs.jsr311-api-1.1.1").versionAsInProject(),
                mavenBundle().groupId("org.apache.neethi").artifactId("neethi").versionAsInProject(),
                mavenBundle().groupId("org.apache.cxf").artifactId("cxf-bundle-jaxrs").versionAsInProject()));
...
*/                
    ...
    public void defaultWebAppTestMethod() throws Exception {
        ...
        providers.add(new org.apache.cxf.jaxrs.provider.JSONProvider());
        WebClient wc = WebClient.create(baseUri);
//        WebClient wc = WebClient.create(baseUri, providers);
