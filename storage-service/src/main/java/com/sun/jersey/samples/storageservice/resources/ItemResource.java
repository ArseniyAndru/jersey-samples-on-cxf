...
public class ItemResource {
    ...
    public Response getItem() {
        ...
        if (i == null)
            throw createNotFoundException("Item not found");
    ...
    public Response putItem(
        ...
        if (ii == null) {
            ...
            if (i == null)
                throw createNotFoundException("Container not found");
        }
    ...
    private WebApplicationException createNotFoundException(String message) {
